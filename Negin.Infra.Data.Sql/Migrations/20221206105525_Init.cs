        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossTonage = table.Column<int>(type: "int", nullable: true),
                    CallSign = table.Column<decimal>(type: "decimal(20,0)", nullable: true),
                    NationalityId = table.Column<int>(type: "int", nullable: true),
                    VesselLength = table.Column<int>(type: "int", nullable: true),
                    VesselWidth = table.Column<int>(type: "int", nullable: true),
                    BaysQuantity = table.Column<byte>(type: "tinyint", nullable: true),
                    ActiveCraneQty = table.Column<byte>(type: "tinyint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vessels_Countries_NationalityId",
