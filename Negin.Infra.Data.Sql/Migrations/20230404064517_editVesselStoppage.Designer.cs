...
namespace Negin.Infra.Data.Sql.Migrations
{
    ...
    [Migration("20230404064517_editVesselStoppage")]
    partial class editVesselStoppage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "f886dd58-9a6a-4dc2-966d-5878350630d3",
                            RoleId = "1"
                        });
                });
            ...
            modelBuilder.Entity("Negin.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f886dd58-9a6a-4dc2-966d-5878350630d3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7a144623-47a0-4217-96af-076942e63f76",
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailConfirmed = false,
                            IsActived = true,
                            LockoutEnabled = false,
                            PasswordHash = "V1XR9c+GxrztWapRrA0QBOThBAwaTaLMEBM8fPCoZbo=",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a77d4fc3-8a86-43f4-b4d9-5af9195fe0ed",
            ...
            modelBuilder.Entity("Negin.Core.Domain.Aggregates.Billing.CleaningServiceInvoiceDetail", b =>
                {
                    ...
                    b.HasOne("Negin.Core.Domain.Aggregates.Operation.VesselStoppage", "VesselStoppage")
                        ...
                        .HasForeignKey("Negin.Core.Domain.Aggregates.Billing.CleaningServiceInvoiceDetail", "VesselStoppageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
