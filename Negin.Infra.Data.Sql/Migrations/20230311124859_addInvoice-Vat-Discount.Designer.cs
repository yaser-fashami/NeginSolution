...
namespace Negin.Infra.Data.Sql.Migrations
{
    ...
    [Migration("20230311124859_addInvoice-Vat-Discount")]
    partial class addInvoiceVatDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "a20720c4-0edd-4fb2-9c9c-0065b2d0e776",
                            RoleId = "1"
                        });
                });
            ...
            modelBuilder.Entity("Negin.Core.Domain.Aggregates.Billing.InvoiceDetail", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.ToTable("InvoiceDetails", "Billing");
                });
            ...
            modelBuilder.Entity("Negin.Core.Domain.Entities.Basic.DiscountTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Negin.Core.Domain.Entities.Basic.VatTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Negin.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a20720c4-0edd-4fb2-9c9c-0065b2d0e776",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "219664bc-692a-4a91-99bf-e4a83ce5d170",
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailConfirmed = false,
                            IsActived = true,
                            LockoutEnabled = false,
                            PasswordHash = "Top6SJ628gZWhkXXKh8rOML2ZL+XPfr1+ra7pJ4JbQI=",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "bec61cc3-7dde-4078-9f8f-faedb9c834d9",
            ...
            modelBuilder.Entity("Negin.Core.Domain.Aggregates.Billing.InvoiceDetail", b =>
                {
                    ...
                    b.HasOne("Negin.Core.Domain.Entities.Basic.Currency", "Currency")
                        .WithMany()
                    ...
                    b.HasOne("Negin.Core.Domain.Aggregates.Operation.VesselStoppage", "VesselStoppage")
                        ...
                        .HasForeignKey("Negin.Core.Domain.Aggregates.Billing.InvoiceDetail", "VesselStoppageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
